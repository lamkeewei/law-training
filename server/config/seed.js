...
Listing.find({}).remove(function() {
  Listing.create({
    ...
    practiceAreas: ['Corporate & Commercial', 'Financial Services', 'Corporate Mergers & Acquisitions', 'Litigation & Dispute Resolution']
  }, {
    ...
    practiceAreas: ['Corporate & Commercial', 'Family Law', 'Intellectual Property Law']
  });
});
